const devices = {
    devices: {
        ...
        deviceDeleteFailed: 'Usuwanie urządzenia zakończone niepowodzeniem',
        ...
        updatingDeviceFailed:
            'Aktualizowanie urządzenia zakończone niepowodzeniem',
        validation: {
            nameMaxLength:
                'Nazwa nie powinna mieć więcej niż {{length}} znaków',
            nameMinLength: 'Nazwa powinna mieć co najmniej {{length}} znaki',
